...
<div>
    ...
    <p>
        Для работы с microfw нужно перекинуть .htaccess из корня mickrofw в корень проекта, <br>
        заменить в файле строку: RewriteRule ^(.*)$ /public/$1 на RewriteRule ^(.*)$ /microfw/public/$1, <br>
